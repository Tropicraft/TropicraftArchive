...
public class ItemBeachFloat extends ItemTropicraft {

    public ItemBeachFloat(int i) {
        super(i);
        setHasSubtypes(true);
        maxStackSize = 1;
    }
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer) {
        ...
        float f9 = f3 * f5;
        double d3 = 5D;
        float f10 = entityplayer.rotationYaw + 180F;
        ...
        if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE && movingobjectposition.sideHit == 1) {
            ...
            if (!world.isRemote) {
                ...
                world.spawnEntityInWorld(new EntityBeachFloat(world, (float) i + 0.5F, (float) j + 1.0F, (float) k + 0.5F, f10, color));
