...
public class ItemBlowGun extends ItemTropicraft {
	...
	public void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityPlayer entityplayer, int i) {
		...
		if (entityplayer.capabilities.isCreativeMode || entityplayer.inventory.hasItemStack(new ItemStack(TropicraftMod.paraDart, 1, itemstack.getItemDamage()))) {

			System.out.println(entityplayer.inventory.hasItemStack(new ItemStack(TropicraftMod.paraDart, itemstack.getItemDamage())));
			...
			for (ItemStack stack : entityplayer.inventory.mainInventory) {
				if (stack != null && stack.getItem().shiftedIndex == TropicraftMod.paraDart.shiftedIndex && stack.getItemDamage() == itemstack.getItemDamage()) {
					break;
				}
				slot++;
			}
			...
			if (!world.isRemote) {
				...
				EntityDart entitydart = new EntityDart(world, entityplayer, f * 2.0F, itemstack.getItemDamage());
