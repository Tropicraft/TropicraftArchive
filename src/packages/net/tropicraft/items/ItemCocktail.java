...
//    	if (stack.stackTagCompound != null) {
//    		Drink drink = Drink.drinkList[stack.stackTagCompound.getByte("DrinkID")];
//    		if (drink == null) {
//    			return DEFAULT_COLOR;
//    		} else {
//    			return drink.color;
...
//    	}
    ...
    public static ItemStack makeCocktail(MixerRecipe recipe) {
		ItemStack stack = new ItemStack(TropicraftMod.cocktail);
    ...
    public static Ingredient[] getIngredients(ItemStack stack) {
    	if (stack.itemID != TropicraftMod.cocktail.shiftedIndex || !stack.hasTagCompound()) {
