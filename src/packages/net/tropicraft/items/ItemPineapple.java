...
public class ItemPineapple extends ItemTropicraft {

    private int spawnID;

    public ItemPineapple(int i, Block block) {
        super(i);
    ...
    public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int i, int j, int k, int l, float par8, float par9, float par10) {
        ...
        if (world.canPlaceEntityOnSide(this.spawnID, i, j, k, false, l, (Entity)null)) {
            ...
            if (world.setBlockAndMetadataWithNotify(i, j, k, spawnID, 1)) {
             //   block.onBlockPlaced(world, i, j, k, l);
            	block.onBlockPlaced(world, i, j, k, l, par8, par9, par10, 0);
