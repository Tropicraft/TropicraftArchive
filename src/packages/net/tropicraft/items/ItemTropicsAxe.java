...
public class ItemTropicsAxe extends ItemToolTropics {
    ...
    public static final Block[] blocksEffectiveAgainst = new Block[] {Block.planks, Block.bookShelf, Block.wood, Block.chest, 
    	Block.stoneDoubleSlab, Block.stoneSingleSlab, Block.pumpkin, Block.pumpkinLantern, TropicraftMod.bambooChest, TropicraftMod.palmPlanks, 
        TropicraftMod.tropicalWood};

    
    public ItemTropicsAxe(int i, EnumToolMaterialTropics enumtoolmaterial) {
