...
public class EntityPoisonousTreeFrogBlue extends EntityAnimal implements IMob
{

    public EntityPoisonousTreeFrogBlue(World world)
    {
        super(world);
        texture = "/tropicalmod/treefrogblue.png";
        setSize(0.9F, 1.3F);
        health = 4;
        savedhealth = health;
        onWall = false;
