...
import net.tropicraft.entities.EntityAmphibian;
...
public class RenderTurtle extends RenderLiving {
    ...
    public void renderTurtle(EntityAmphibian entityTurtle, double d, double d1, double d2,
        ...
        try {
            ...
            float f7 = entityTurtle.prevLegYaw + (entityTurtle.legYaw - entityTurtle.prevLegYaw) * f1;
            float f8 = entityTurtle.legSwing - entityTurtle.legYaw * (1.0F - f1);
