        ...
        if(this.blockID == 0) {
            ...
            if(this.onGround) {
                ...
                if(this.worldObj.getBlockId(var1, var2, var3) != Block.pistonMoving.blockID) {
                    ...
                    if((!this.worldObj.canPlaceEntityOnSide(this.blockID, var1, var2, var3, true, 1, (Entity)null) || BlockSand.canFallBelow(this.worldObj, var1, var2 - 1, var3) || !this.worldObj.setBlockAndMetadataWithNotify(var1, var2, var3, this.blockID, this.metadata)) && !this.worldObj.isRemote) {
