...
public class TileEntityPurchasePlateRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityMobSpawner(TileEntityPurchasePlate par1TileEntityMobSpawner, double par2, double par4, double par6, float par8)
    {
    	...
    	if (par1TileEntityMobSpawner.tradeState == 1) {
    		...
    		Item item = ValuedItems.getItemBuyable(par1TileEntityMobSpawner.itemIndex);
    		String name = "???";
    		if (item != null) {
	    		...
	    		if (is != null) {
	    			...
	    			if (ValuedItems.getBuyItemCount(item) > 1) {
	    				name += " x" + ValuedItems.getBuyItemCount(item);
	    			}
    	...
    	if (par1TileEntityMobSpawner.tradeState > 0) {
	    	...
	    	if (lastWorldTick != par1TileEntityMobSpawner.worldObj.getWorldTime()) {
	    		lastWorldTick = par1TileEntityMobSpawner.worldObj.getWorldTime();
    ...
    public void renderEntityItem2(TileEntityPurchasePlate par1TileEntityMobSpawner, double par2, double par4, double par6, float par8) {
    	...
    	RenderManager.instance.itemRenderer.renderItem(FMLClientHandler.instance().getClient().thePlayer, new ItemStack(ValuedItems.getItemBuyable(par1TileEntityMobSpawner.itemIndex)), 0);
    ...
    public void renderEntityItem() {
        ...
        re.bindTexture(re.getTexture("/misc/mapbg.png"));
    ...
    protected void renderBanner(TileEntityPurchasePlate par1TileEntityMobSpawner, double par3, double par5, double par7, float par8) {
    	...
    	String par2Str2 = "Cost: " + ValuedItems.getBuyableItemCostByIndex(par1TileEntityMobSpawner.itemIndex);
