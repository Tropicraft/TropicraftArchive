...
public class TileEntitySifterRenderer extends TileEntitySpecialRenderer
{
	...
	public void renderTileEntitySifter(TileEntitySifter tileentitysifter, double d, double d1, double d2, 
			float f)
	{
		GL11.glPushMatrix();
		GL11.glTranslatef((float)d + 0.5F, (float)d1, (float)d2 + 0.5F);

	//	System.out.println(tileentitysifter.isSifting());
		
		if(entity == null && tileentitysifter.isSifting())
		{
			
		//	entity = new EntityItem(tileentitysifter.getWorldObj());
			//	System.out.println("null entity");
			//		if(tileentitysifter.sifting){
			entity = (EntityItem)(new EntityItem(tileentitysifter.getWorldObj()));
			((EntityItem)entity).func_92013_a(new ItemStack(Block.sand, 1));

			//       		entityHashMap.put("Sifter", entity);
			//		}
		//	((EntityItem)entity).item = new ItemStack(Block.sand, 1);

		}

		if(entity != null) 
		{
			//System.out.println(tileentitysifter.sifterSiftTime);
