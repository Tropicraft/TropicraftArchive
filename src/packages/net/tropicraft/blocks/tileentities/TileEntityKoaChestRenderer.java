...
public class TileEntityKoaChestRenderer extends TileEntitySpecialRenderer
{
    ...
    public void renderChest(TileEntityKoaChest tileentitybamboochest, double d, double d1, double d2,
            float f)
    {
        int i;
        ...
        else
        {
            ...
            if (block != null && i == 0)
            {
                ((BlockKoaChest)block).unifyAdjacentChests(tileentitybamboochest.worldObj, tileentitybamboochest.xCoord, tileentitybamboochest.yCoord, tileentitybamboochest.zCoord);
                i = tileentitybamboochest.getBlockMetadata();
            }
        ...
        if (tileentitybamboochest.adjacentChestXPos != null || tileentitybamboochest.adjacentChestZPosition != null)
        {
            ...
            bindTextureByName("/tropicalmod/largechest.png");
        }
        else
        {
            modelchest = chestModel;
            bindTextureByName("/tropicalmod/chest.png");
        }
        GL11.glPushMatrix();
