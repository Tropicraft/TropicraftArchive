...
public class BlockStationaryLAPI extends BlockFluidLAPI
{
	public BlockStationaryLAPI(int par1, int liqID, Material par2Material)
	{
		super(par1, liqID, par2Material);
		this.liquidID = liqID;
        blockIndexInTexture = LAPI.getTextureIDFromLiquidID(liqID, false);
	...
	private void setNotStationary(World par1World, int par2, int par3, int par4)
	{
		...
		par1World.setBlockAndMetadata(par2, par3, par4, LAPI.getPairedBlockID(this.blockID), var5);
		par1World.markBlockRangeForRenderUpdate(par2, par3, par4, par2, par3, par4);
		par1World.scheduleBlockUpdate(par2, par3, par4, LAPI.getPairedBlockID(this.blockID), this.tickRate());
