...
public class BlockFlowingLAPI extends BlockFluidLAPI {
	    /**
	    ...
	    public BlockFlowingLAPI(int par1, int liqID, Material par2Material)
	    {
	        super(par1, liqID, par2Material);
	        this.liquidID = liqID;
	        blockIndexInTexture = LAPI.getTextureIDFromLiquidID(liqID, true);
	    }
