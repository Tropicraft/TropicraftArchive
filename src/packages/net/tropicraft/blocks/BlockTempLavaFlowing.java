...
public class BlockTempLavaFlowing extends BlockFlowing {
    ...
    public BlockTempLavaFlowing(int par1)
    {
    ...
    private void updateFlow(World par1World, int par2, int par3, int par4)
    {
        ...
        par1World.setBlockAndMetadata(par2, par3, par4, this.blockID, var5);
