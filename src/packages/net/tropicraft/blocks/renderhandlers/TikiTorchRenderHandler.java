...
public class TikiTorchRenderHandler implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
         ...
         int texX = (textureID & 0x0f) << 4;
         int texY = textureID & 0xf0;
         float pixX1 = (float) texX / 256.0F;
         float pixX2 = ((float) texX + 15.99F) / 256.0F;
         float pixY1 = (float) texY / 256.0F;
         float pixY2 = ((float) texY + 15.99F) / 256.0F;
