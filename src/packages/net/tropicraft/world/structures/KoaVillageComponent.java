...
public abstract class KoaVillageComponent {
    ...
    protected static final List<Integer> waterBlockIDs = Arrays.asList(Block.waterMoving.blockID, Block.waterStill.blockID, TropicraftMod.waterMovingTropics.blockID, TropicraftMod.waterStillTropics.blockID);
    ...
    protected void place(World world, int x, int y, int z, Block b) {
        world.setBlockWithNotify(x, y, z, b.blockID);
    }
    ...
    protected void placeDownTilGround(World world, int x, int y, int z, Block block1) {
        while (waterBlockIDs.contains(world.getBlockId(x, y, z)) || world.getBlockId(x, y, z) == 0) {
