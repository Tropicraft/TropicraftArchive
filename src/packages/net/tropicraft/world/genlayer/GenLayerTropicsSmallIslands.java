...
public class GenLayerTropicsSmallIslands extends GenLayerTropicraft {
	
	 public GenLayerTropicsSmallIslands(long l, GenLayer genlayer)
     {
        super(l);
        parent = genlayer;
     } 
	 ...
	 public int[] getInts(int par1, int par2, int par3, int par4)
     {
        ...
        for (int var11 = 0; var11 < par4; ++var11)
        {
            for (int var12 = 0; var12 < par3; ++var12)
            {
                ...
                {
                    var10[var12 + var11 * par3] = 61 + nextInt(4);
                }
                else
                {
