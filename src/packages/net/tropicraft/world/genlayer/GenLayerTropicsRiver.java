...
public class GenLayerTropicsRiver extends GenLayerTropicraft {
	
	 	public GenLayerTropicsRiver(long l, GenLayer genlayer)
	    {
	        super(l);
	        ...
	        for (int var11 = 0; var11 < par4; ++var11)
	        {
	            for (int var12 = 0; var12 < par3; ++var12)
	            {
	                ...
	                if (var17 != 0 && var13 != 0 && var14 != 0 && var15 != 0 && var16 != 0)
	                {
	                    ...
	                    {
	                        var10[var12 + var11 * par3] = BiomeGenTropicraft.tropicsRiver.biomeID;
	                    }
	                }
	                else
	                {
