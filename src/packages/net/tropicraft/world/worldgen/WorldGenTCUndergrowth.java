...
public class WorldGenTCUndergrowth extends WorldGenerator 
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (boolean var6 = false; ((var15 = par1World.getBlockId(par3, par4, par5)) == 0 || var15 == TropicraftMod.tropicLeaves.blockID) && par4 > 0; --par4)
        {
            ;
        }
            ...
            for (int var8 = par4; var8 <= par4 + 2; ++var8)
            {
                ...
                for (int var11 = par3 - var10; var11 <= par3 + var10; ++var11)
                {
                    ...
                    for (int var13 = par5 - var10; var13 <= par5 + var10; ++var13)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, var11, var8, var13, TropicraftMod.tropicLeaves.blockID, 3);
                        }
                    }
                }
            }
