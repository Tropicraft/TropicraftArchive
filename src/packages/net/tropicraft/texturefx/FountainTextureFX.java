...
public class FountainTextureFX extends FMLTextureFX {

	private static final String SPRITE_SHEET_LOC = "/tropicalmod/fountain_sheet.png";
	...
	public FountainTextureFX(int icon) {
		super(icon);
		setup();
	}
    ...
    public void onTick()
    {
        ...
        for (var2 = 0; var2 < tileSizeSquare; ++var2)
        {
            ...
            this.imageData[var2 * 4 + 1] = (byte)(var6 + 60);
            this.imageData[var2 * 4 + 2] = (byte)(var7 + 180);
