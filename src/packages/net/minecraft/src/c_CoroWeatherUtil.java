...
public class c_CoroWeatherUtil
{
	...
	public static String[] noFloatEnts_tropical = {"EntityTropicalFish", "EntityTropicraftWaterMob", "EntityAmphibian", "EntityManOWar"};
	public static String[] noWindEnts_tropical = {"EntityTropicalFish", "EntityTropicraftWaterMob", "EntityAmphibian", "EntityManOWar"};
