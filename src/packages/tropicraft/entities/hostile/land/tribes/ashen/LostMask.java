...
public class LostMask extends Entity implements WindHandler{
	...
	public LostMask(World par1World) {
		super(par1World);
		this.setSize(1f, 1f);
	}
	/**
	 ...
	 */
	public LostMask(World world, int color, double x, double y, double z, double angle){
		this(world);
	...
	public void dropItemStack() {
		this.entityDropItem(new ItemStack(TropicraftItems.ashenMasks, 1, getColor()), 0.0F);
	}
	...
	public boolean checkForWater(int i){
		return worldObj.getBlockMaterial((int)Math.floor(posX), (int) Math.floor(posY) + i, (int)Math.floor(posZ)) == Material.water;
	}
	public int getMode() {
		// TODO Auto-generated method stub
		return 0;
