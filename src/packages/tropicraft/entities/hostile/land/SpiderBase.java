...
import tropicraft.entities.ai.jobs.v3.JobAttackTargetShare;
import tropicraft.entities.hostile.EntityLand;
import CoroUtil.componentAI.jobSystem.JobHunt;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class SpiderBase extends EntityLand implements IMob {
	...
	protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (this.rand.nextInt(10) == 0) this.dropItem(Item.silk.itemID, 1);
