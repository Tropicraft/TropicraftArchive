package tropicraft.entities.hostile;
...
public class EntityLand extends EntityLiving implements ICoroAI, IMob {

	public AIAgent agent;
	
	public EntityLand(World par1World) {
		super(par1World);
		setSize(.7F, 1.95F);
		health = getMaxHealth();
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, int par2) {
		if (!worldObj.isRemote) {
			...
			if (agent != null && agent.jobMan != null) agent.jobMan.hookHit(par1DamageSource, par2);
		} else {
