package tropicraft.entities.passive.flying;
...
public class Failgull extends EntityFlying {
	...
	public Failgull(World par1World) {
		super(par1World);
		texture = "/mods/TropicraftMod/textures/entities/failgull.png";
		setSize(0.4F, 0.6F);
	}
	...
	protected void updateEntityActionState()
	{
		...
		if (this.worldObj.difficultySetting == 0) setDead();
