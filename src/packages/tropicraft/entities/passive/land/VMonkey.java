...
import CoroAI.componentAI.jobSystem.JobPlay;
import CoroAI.componentAI.jobSystem.JobTamable;
...
public class VMonkey extends EntityLand implements IInvUser {
	...
	public VMonkey(World par1World) {
		super(par1World);
		setSize(0.8F, 0.8F);
		texture = "/mods/TropicraftMod/textures/entities/monkeytext.png";
	...
	protected String getLivingSound() {
		return this.isPotionActive(Potion.confusion.id) ? "monkeyhiccup" : "monkeyliving";
	}
