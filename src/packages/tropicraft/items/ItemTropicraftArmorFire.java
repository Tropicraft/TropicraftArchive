...
public class ItemTropicraftArmorFire extends ItemTropicraftArmor {
	...
	public ItemTropicraftArmorFire(int par1, int par3, int par4) {
    ...
    public void onArmorTickUpdate(World world, EntityPlayer player, ItemStack itemStack)
    {
    	if (world.isRemote) {
			...
			int factor = (int)(40D / (0.001D+player.worldObj.getSunBrightness(1F)));
    ...
    {
		return slot == 2 ? "/mods/TropicraftMod/textures/armor/fire_2.png" : slot == 0 || slot == 1 || slot == 3 ? "/mods/TropicraftMod/textures/armor/fire_1.png" : null;
    }
