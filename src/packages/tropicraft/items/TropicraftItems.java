...
import static tropicraft.ModIds.*;
...
public class TropicraftItems {
	...
	public static Item rodOld, rodGood, rodSuper, lureSuper;
	...
	public static void init() {
		...
		staffFire = (ItemStaffFireball) (new ItemStaffFireball(ModIds.ITEM_STAFFFIRE_ID)).setUnlocalizedName("staff_fire").setCreativeTab(TropiCreativeTabs.tabCombat);
		...
		staffTaming = (ItemStaffOfTaming) (new ItemStaffOfTaming(ModIds.ITEM_STAFFTAMING_ID)).setUnlocalizedName("staff_taming").setCreativeTab(TropiCreativeTabs.tabCombat);
		...
		spearBamboo = (new ItemTropicsSword(ModIds.ITEM_BAMBOOSPEAR_ID, "bambooSpear", EnumToolMaterialTropics.BAMBOO)).setUnlocalizedName("bambooSpear");

		bambooDoor =  new ItemBambooDoor(ITEM_BAMBOODOOR_ID, "bamboodoor").setUnlocalizedName("bambooDoor");

		scaleBoots = (new ItemTropicraftArmorScale(ITEM_SCALEBOOTS_ID, "scale_boots", 0, 3)).setUnlocalizedName("scale_boots");
		scaleHelm = (new ItemTropicraftArmorScale(ITEM_SCALEHELM_ID, "scale_helm", 0, 0)).setUnlocalizedName("scale_helm");
		scaleLeggings = (new ItemTropicraftArmorScale(ITEM_SCALELEGGINGS_ID, "scale_leggings", 0, 2)).setUnlocalizedName("scale_leggings");
		scaleChestplate = (new ItemTropicraftArmorScale(ITEM_SCALECHESTPLATE_ID, "scale_chestplate", 0, 1)).setUnlocalizedName("scale_chestplate");

		fireBoots = (new ItemTropicraftArmorFire(ModIds.ITEM_FIREBOOTS_ID, "fire_boots", 0, 3)).setUnlocalizedName("fire_boots");
		fireHelm = (new ItemTropicraftArmorFire(ModIds.ITEM_FIREHELM_ID, "fire_helm", 0, 0)).setUnlocalizedName("fire_helm");
		fireLeggings = (new ItemTropicraftArmorFire(ModIds.ITEM_FIRELEGGINGS_ID, "fire_leggings", 0, 2)).setUnlocalizedName("fire_leggings");
		fireChestplate = (new ItemTropicraftArmorFire(ModIds.ITEM_FIRECHESTPLATE_ID, "fire_chestplate", 0, 1)).setUnlocalizedName("fire_chestplate");
		...
		rodOld = new ItemRod(ModIds.ITEM_OLDROD).setType(ItemRod.TYPE_OLD).setUnlocalizedName("rodOld");
		rodGood = new ItemRod(ModIds.ITEM_GOODROD).setType(ItemRod.TYPE_GOOD).setUnlocalizedName("rodGood");
		rodSuper = new ItemRod(ModIds.ITEM_SUPERROD).setType(ItemRod.TYPE_SUPER).setUnlocalizedName("rodSuper");
		lureSuper = new ItemTropicraftImpl(ModIds.ITEM_LURESUPER, "fishingLure").setUnlocalizedName("lureSuper");
		...
		registerItem(recordSummering, "Summering");
		...
		registerItem(lureSuper, "Super Lure");
	}
