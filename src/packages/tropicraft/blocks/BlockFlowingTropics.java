...
public class BlockFlowingTropics extends BlockFluidTropics {
	...
	public BlockFlowingTropics(int par1, Material par2Material) {
	...
	private void updateFlow(World par1World, int par2, int par3, int par4)
	{
		...
		par1World.setBlock(par2, par3, par4, TropicraftBlocks.tropicsWaterStationary.blockID, l, 2);
	}
