...
import tropicraft.blocks.tileentities.ModelEIHMixer;
...
public class TileEntityEIHMixerRenderer extends TileEntitySpecialRenderer {
  ...
  /**
	...
	private void renderEIHMixer(TileEntityEIHMixer te, double x, double y, double z, float partialTicks) {
        ...
        this.bindTextureByName("/mods/"+ModInfo.MODID+"/textures/blocks/tileentities/eihmixer.png");
		...
		if (!te.isDoneMixing()) {
			if (ingredients[0] != null) {
				...
				renderItem.doRenderItem(dummyEntityItem, 0.0, 0.0, 0.0, 0f, 0f);
				GL11.glPopMatrix();
			}
		...
		if (te.isMixing()) {
			...
			this.bindTextureByName("/mods/"+ModInfo.MODID+"/textures/blocks/tileentities/bamboomug.png");
