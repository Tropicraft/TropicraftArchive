...
import tropicraft.blocks.tileentities.ModelCurareBowl;
...
public class TileEntityCurareBowlRenderer extends TileEntitySpecialRenderer {
	...
	private EntityItem dummyEntityItem = new EntityItem(null, 0.0, 0.0, 0.0, new ItemStack(Item.sugar));
	...
	private void renderBowl(TileEntityCurareBowl bowl, double x, double y, double z, float partialTicks) {
		...
		this.bindTextureByName(ModInfo.TEXTURE_BLOCK_LOC + "bowl.png");
