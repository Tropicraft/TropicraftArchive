...
public class BlockTropicraftPortal extends BlockFluid {
    ...
    public void onEntityCollidedWithBlock(World world, int i, int j, int k, Entity entity) {
      ...
      //DEBUG:      System.out.println(((EntityPlayerMP)entity).timeUntilPortal);
            ...
            if (((EntityPlayerMP)entity).timeUntilPortal > TIME_UNTIL_TELEPORT && ((EntityPlayerMP)entity).isPotionActive(Potion.confusion.id))
            {
                ((EntityPlayerMP)entity).timeUntilPortal = 0;
                ((EntityPlayerMP)entity).removePotionEffect(Potion.confusion.id);
                TropicraftWorldUtils.teleportPlayer((EntityPlayerMP)entity);
            }
    	}
    }
