...
public class BlockFluidTropics extends Block {

	@SideOnly(Side.CLIENT)
	private Icon[] theIcon;

	public BlockFluidTropics(int par1, Material par2Material) {
	...
	{
		return BlockFluid.getFlowDirection(par0IBlockAccess, par1, par2, par3, par4Material);
	}
	...
	{
		this.theIcon = new Icon[] {par1IconRegister.registerIcon(ModInfo.ICONLOCATION + "water"), par1IconRegister.registerIcon(ModInfo.ICONLOCATION + "water_flow")};
	}
}
