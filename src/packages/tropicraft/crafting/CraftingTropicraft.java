...
enchantwand.desc = Make a 2 block wide, 2 block long, 1 block high square of tropics water, toss in an item you want enchanted, and toss in the necessary amount of azurite crystals. Right click this area with the Wand o' Enchanting, and voila, you have an awesome enchanted item!
		...
		createRecipe(true, new ItemStack(TropicraftItems.rodOld), new Object[]{
			"  I",
			" IX",
			"I V",
		...
		createRecipe(true, new ItemStack(TropicraftItems.rodGood), new Object[]{
			"  I",
			" IX",
			"I V",

			'X', Item.silk,
			'V', TropicraftItems.lemon,
			'I', TropicraftItems.bambooStick
		});

		createRecipe(true, new ItemStack(TropicraftItems.rodSuper), new Object[]{
			"  I",
			" IX",
			"I V",

			'X', Item.silk,
			'V', TropicraftItems.lureSuper,
			'I', TropicraftItems.bambooStick
		});

		createRecipe(true, new ItemStack(TropicraftItems.lureSuper), new Object[]{
			" X ",
			"XOX",
			" X ",
			'X', Item.ingotIron,
