...
public class MapGenTropicsCaves extends MapGenBase
{
     ...
     */
    protected void generateCaveNode(long par1, int par3, int par4, short[] par5ArrayOfByte, double par6, double par8, double par10, float par12, float par13, float par14, int par15, int par16, double par17)
    {
