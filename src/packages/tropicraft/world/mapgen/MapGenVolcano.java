...
public class MapGenVolcano {
    ...
    private final int CALDERA_CUTOFF = 110; //The Y level where if the height of the volcano would pass becomes the caldera
    private final int VOLCANO_TOP = 103; //The Y level cut off of the sides of the volcano
    private final int VOLCANO_CRUST = 100; //The Y level where the crust of the volcano generates
    private final int LAVA_LEVEL = 95; //The Y level where the top of the lava column is
