...
import tropicraft.world.genlayer.GenLayerTropicraft;
...
public class WorldChunkManagerTropicraft extends WorldChunkManager {
	...
	public static ArrayList<BiomeGenBase> allowedBiomes = new ArrayList<BiomeGenBase>(Arrays.asList(BiomeGenTropicraft.tropics, BiomeGenTropicraft.rainforestPlains));
    ...
    public WorldChunkManagerTropicraft(long par1, WorldType par3WorldType)
    {
        this();
        GenLayer[] agenlayer = GenLayerTropicraft.initializeAllBiomeGenerators(par1, par3WorldType);
        this.genBiomes = agenlayer[0];
        this.biomeIndexLayer = agenlayer[1];
    }

    public WorldChunkManagerTropicraft(World par1World)
    {
