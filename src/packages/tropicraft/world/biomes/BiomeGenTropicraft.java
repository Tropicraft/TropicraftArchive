...
public class BiomeGenTropicraft extends BiomeGenBase {
	...
	//Biome IDs
	public static int bIDtropicsOcean = TropicraftConfig.biomeTropicsOceanID;
	public static int bIDtropics = TropicraftConfig.biomeTropicsID;
	public static int bIDrainforestPlains = TropicraftConfig.biomeRainforestPlainsID;
	public static int bIDrainforestHills = TropicraftConfig.biomeRainforestHillsID;
	public static int bIDrainforestMountains = TropicraftConfig.biomeRainforestMountainsID;
	public static int bIDtropicsRiver = TropicraftConfig.biomeTropicsRiverID;
	public static int bIDtropicsBeach = TropicraftConfig.biomeTropicsBeachID;
	public static int bIDlake = TropicraftConfig.biomeLakeID;
	public static int bIDislandMountain = TropicraftConfig.biomeIslandMountainID;
	...
	public short sandID = (byte)Block.sand.blockID;
