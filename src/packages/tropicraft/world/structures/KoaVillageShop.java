...
public class KoaVillageShop extends KoaVillageComponent {
    ...
    public boolean canFitInWorld(World world) {
		...
		//System.out.println("village test override is on");
		//if (true) return true;
	...
	public void generateSchematic(World world) {
		...
		String str = "TradeHut";
    	BuildJob bj = new BuildJob(buildID, homeX, homeY, homeZ, WorldDirector.getSaveFolderPath() + "assets" + File.separator + "tropicraftmod" + File.separator + "schematics" + File.separator + str);
	...
	public void generate(World world) {
		...
		//System.out.println("genDirection: " + genDirection);
	...
	private void placeShopFrame(World world, int i, int j, int k) {
		/*EntityHangingTropicraft var38; TODO
		try {
