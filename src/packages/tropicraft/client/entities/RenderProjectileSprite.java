...
public class RenderProjectileSprite extends Render
{
    ...
    public RenderProjectileSprite(Item par1, int par2)
    {
        this.item = par1;
        this.damage = par2;
    }

    public RenderProjectileSprite(Item par1)
    {
        this(par1, 0);
    }
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return TextureMap.locationItemsTexture;// new ResourceLocation("/gui/items.png");
	}
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (icon != null)
        {
            ...
            if (icon == ItemPotion.func_94589_d("potion_splash"))
            {
                ...
                GL11.glPushMatrix();
                this.renderIcon(tessellator, ItemPotion.func_94589_d("potion_contents"));
                GL11.glPopMatrix();
