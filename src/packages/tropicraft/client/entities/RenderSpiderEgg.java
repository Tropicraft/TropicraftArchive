...
public class RenderSpiderEgg extends RenderLiving {
    ...
    public void func_177_a(SpiderEgg entity, double d, double d1, double d2,
            float f, float f1) {
    ...
    public void doRenderLiving(EntityLiving entityliving, double d, double d1, double d2,
            float f, float f1) {
        super.doRenderLiving((SpiderEgg) entityliving, d, d1, d2, f, f1);
    }

    @Override
    public void doRender(Entity entity, double d, double d1, double d2,
            float f, float f1) {
        doRenderLiving((SpiderEgg) entity, d, d1, d2, f, f1);
    }
