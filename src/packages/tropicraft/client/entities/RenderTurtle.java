...
import tropicraft.entities.passive.water.EntityAmphibian;

public class RenderTurtle extends RenderLiving {

    public ModelTurtle turtle;

    public RenderTurtle(ModelBase modelbase, float f) {
        super(modelbase, f);
        turtle = (ModelTurtle) modelbase;
    }
    ...
    public void renderTurtle(EntityAmphibian entityTurtle, double d, double d1, double d2,
        ...
        try {
            ...
            float f7 = entityTurtle.prevLimbYaw + (entityTurtle.limbYaw - entityTurtle.prevLimbYaw) * f1;
            float f8 = entityTurtle.limbSwing - entityTurtle.limbYaw * (1.0F - f1);
    ...
    public void doRenderLiving(EntityAmphibian entityTurtle, double d, double d1, double d2,
            float f, float f1) {
