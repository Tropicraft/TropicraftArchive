...
public class RenderDart extends Render {
    ...
    public void renderArrow(EntityDart dart, double x, double y, double z,
            float f, float f1) {
        if (dart.ridingEntity != null) {
            return;
        }
        if (dart.prevRotationYaw == 0.0F && dart.prevRotationPitch == 0.0F) {
            return;
        }
        TropicraftUtils.bindTextureEntity("darts");
        GL11.glPushMatrix();
        ...
        float f10 = 0.03625F;//controlls scale
    ...
    public void doRender(Entity entity, double d, double d1, double d2,
            float f, float f1) {
        renderArrow((EntityDart) entity, d, d1, d2, f, f1);
    }
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return TropicraftUtils.bindTextureEntity("darts");
	}
}
