				...
				if (var2.length > 0) {
					if (var2[0].equalsIgnoreCase("spawn")) {
						...
						if (var2[1].equalsIgnoreCase("village")) {
							System.out.println("trying village gen here");
							int dir = -1;
							try {
					    	...
					    	//fix code to recenter now that rotation method doesnt center
					    	bj.build_startX -= bj.build.map_sizeX / 2;
					    	//bj.build_startY -= bj.build.map_sizeY / 2;
					    	bj.build_startZ -= bj.build.map_sizeZ / 2;
