...
public class ItemRod extends Item
{
    ...
    public ItemRod(int par1)
    {
        ...
        this.setCreativeTab(TropiCreativeTabs.tabTools);
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        this.theIcon = par1IconRegister.registerIcon("TropicraftMod:fishingRod");
        this.oldIcon = par1IconRegister.registerIcon("TropicraftMod:fishingRodOld");
        this.superIcon = par1IconRegister.registerIcon("TropicraftMod:fishingRodSuper");
        this.goodIcon = par1IconRegister.registerIcon("TropicraftMod:fishingRodGood");
