...
public class WaveRenderer extends Render
{
    ...
    public void vboRender(Block block, float var2, float height, float ampheight, float magnitude, float angle, float waveTime, int xx, int zz, float var3, float var4, float var5, float var6, float var7)
    {
        ...
        int what = getParticleTextureIndex(dim, block) % 16;
        int what2 = getParticleTextureIndex(dim, block) / 16;
    ...
    public void renderTopFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        int var10 = (par8 & 15) << 4;
        int var11 = par8 & 240;
        double var12 = ((double)var10 + par1Block.getBlockBoundsMinX() * 16.0D) / 256.0D;
        double var14 = ((double)var10 + par1Block.getBlockBoundsMaxX() * 16.0D - 0.01D) / 256.0D;
        double var16 = ((double)var11 + par1Block.getBlockBoundsMinZ() * 16.0D) / 256.0D;
        double var18 = ((double)var11 + par1Block.getBlockBoundsMaxZ() * 16.0D - 0.01D) / 256.0D;
        ...
        double var24 = var16;
        double var26 = var18;
        double var28 = par2 + par1Block.getBlockBoundsMinX();
        double var30 = par2 + par1Block.getBlockBoundsMaxX();
        double var32 = par4 + par1Block.getBlockBoundsMaxY();
        double var34 = par6 + par1Block.getBlockBoundsMinZ();
        double var36 = par6 + par1Block.getBlockBoundsMaxZ();
        //Weather code change
